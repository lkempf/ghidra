...
/**
 * This class represents the <code>OLD_IMAGE_DOS_HEADER</code> struct
...
public class OldDOSHeader implements StructConverter, Writeable {
    ...
    public final static String NAME = "OLD_IMAGE_DOS_HEADER";
	public final static int IMAGE_DOS_SIGNATURE = 0x5A4D; // MZ
    public final static int SIZEOF_DOS_HEADER   = 28;
     ...
     */
    public static OldDOSHeader createOldDOSHeader(
            FactoryBundledWithBinaryReader reader) throws IOException {
        OldDOSHeader OldDOSHeader = (OldDOSHeader) reader.getFactory().create(OldDOSHeader.class);
        OldDOSHeader.initOldDOSHeader(reader);
        return OldDOSHeader;
    }
    ...
    private void initOldDOSHeader(FactoryBundledWithBinaryReader reader) throws IOException {
        this.reader = reader;
